...
if (isset($_POST[login])){
 ...
 $data=anti_injection($_POST['b']);
 $pass=hash("md5",$data);
 //~ echo "SELECT * FROM user WHERE username='".$_POST['a']."' AND password='".$pass."'";exit;
 $admin = mysql_query("SELECT * FROM user WHERE username='".$_POST['a']."' AND password='".$pass."'");
