              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM users ORDER BY id_user DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM users where id_user='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[update])){
      ...
      if (trim($_POST[b])==''){
        mysql_query("UPDATE users SET username = '$_POST[a]',
    ...
    $edit = mysql_query("SELECT * FROM users a where a.id_user='$_GET[id]'");
    ...
    if (isset($_POST[tambah])){
      $data = md5($_POST[b]);
      $passs=hash("sha512",$data);
      mysql_query("INSERT INTO users VALUES('','$_POST[a]','$passs','$_POST[c]','$_POST[d]','superuser')");
      echo "<script>document.location='index.php?view=admin';</script>";
    }
