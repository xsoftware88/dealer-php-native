...
$inputFileName = '../../temp/upload/bengkel/excel/STOK-POSISI-UNIT.xls';
...
//~ var_dump($rowData[0]);exit;
    ...
    $posisi     	= mysqli_real_escape_string($mysqli,strtoupper($rowData[0][1]));
    
    $sqlUnit = "SELECT *
    FROM unit_stok
    WHERE noka = '".$noka."'
    ORDER BY `unit_stok`.`noka` DESC limit 1";
